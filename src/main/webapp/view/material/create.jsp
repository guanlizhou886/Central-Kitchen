                    ...
                    <fieldset>
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-sm-4">
						   ...
						   <div class="form-group">
							   <label class="col-sm-2 control-label" for="ds_host">图片信息</label>
							   <div class="col-sm-4">
                       ...
                       <div class="form-group">
                          ...
                          <div class="col-sm-4">
						   ...
						   <div class="form-group">
							   ...
							   <div class="col-sm-4">
								   <input class="form-control" type="text" name="MATERIAL_UNIT"/>
							   </div>
							   <div class="form-group">
								   <label class="col-sm-2 control-label" for="ds_username">物资状态</label>
								   <div class="col-sm-4">
