...
<%--    <link rel="stylesheet" href="../../../static/css/plugins/ztree/demo.css" type="text/css">--%>
    <link rel="stylesheet" href="../../../static/css/plugins/ztree/zTreeStyle/zTreeStyle.css" type="text/css">
...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox float-e-margins">
        <form action="${path }/mtype/create.do" method="post" class="form-horizontal" role="form">
            <input type="hidden1" id="typeParentId" name="typeParentId" />
            ...
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input class="form-control" id="mtypeSel" name="menuName" readonly type="text" />
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <input class="form-control" id="typeSimpName" name="typeSimpName" type="text" />
                    </div>
                </div>
            </fieldset>
            <fieldset>
